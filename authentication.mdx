...
<Info>
**Get your free API key** at [dashboard.predexon.com](https://dashboard.predexon.com) to unlock 20x higher rate limits and premium features.
</Info>

## Getting Started

The Predexon API requires an API key for all requests. **Signing up is free** at [dashboard.predexon.com](https://dashboard.predexon.com).
