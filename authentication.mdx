...
<Info>
**Get your free API key** at [dashboard.predexon.com](https://dashboard.predexon.com). Upgrade to Pro or Desk for higher rate limits and unlimited requests.
</Info>
...
| Tier | Rate Limit | Monthly Requests | WebSocket Subs | Price |
|------|------------|------------------|----------------|-------|
| Free | 1 req/sec | 25,000 | 5 | $0/month |
| Pro | 20 req/sec (40 burst) | Unlimited | 100 | $129/month |
| Desk | 100 req/sec (200 burst) | Unlimited | 1,000 | $499/month |
