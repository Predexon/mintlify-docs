...
<Steps>
  ...
  <Step title="Make Your First Request">
    ...
    curl -H "x-api-key: YOUR_API_KEY" \
      "https://api.predexon.com/v1/polymarket/markets?status=open&sort=volume&limit=5"
    ```
...
<Note>
Free tier excludes smart wallet and market matching endpoints. See [predexon.com/pricing](https://predexon.com/pricing) for overage pricing and WebSocket limits.
</Note>
