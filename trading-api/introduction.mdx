...
All wallet private keys are managed by [Turnkey](https://turnkey.com) - Predexon never stores or has access to user private keys. Keys are generated and stored in Turnkey's secure hardware enclaves.
...
<CardGroup cols={2}>
  ...
  <Card title="Trading" icon="arrow-right-arrow-left" href="/trading-api/trading/place-order-polymarket">
...
<Accordion title="Blocked Countries (51 total)">
...
<Note>
You can also use the [Bridge API](/trading-api/funds/deposit-info) to deposit from Ethereum, Solana, Bitcoin, or other chains. Funds are automatically converted to USDC.e and deposited to your Polymarket wallet.
</Note>
