...
<Info>
The Predexon MCP server lets AI assistants like Claude, Cursor, Windsurf, and others directly query prediction market data from Polymarket, Kalshi, and Dflow.
</Info>
...
| Tool | Description |
|------|-------------|
| `find_matching_markets` | Find equivalent markets across Polymarket and Kalshi |
| `get_matched_pairs` | Get all active matched market pairs |
