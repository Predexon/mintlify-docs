---
title: "Activity"
api: "GET /v1/polymarket/activity"
...
<ResponseField name="pagination" type="object">
  <Expandable>
    ...
    <ResponseField name="count" type="integer">Total count</ResponseField>
...
<RequestExample>
```bash cURL
curl "https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/activity?user=0x1234...&limit=50"
```
...
response = requests.get(
    "https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/activity",
    params={
...
const response = await fetch(
  `https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/activity?user=${walletAddress}&limit=50`
);
