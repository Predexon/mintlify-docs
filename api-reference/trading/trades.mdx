...
curl "https://api.predexon.com/v1/polymarket/trades?market_slug=will-donald-trump-win-the-2024-us-presidential-election&limit=50"

# Trades for a specific user
curl "https://api.predexon.com/v1/polymarket/trades?user=0x1234...&limit=100"
```
