...
curl "https://api.predexon.com/v1/matching-markets?polymarket_market_slug=will-the-carolina-hurricanes-win-the-metropolitan-division-123"

# From Kalshi to Polymarket
curl "https://api.predexon.com/v1/matching-markets?kalshi_market_ticker=KXNHLMETROPOLITAN-26-CAR"
```
