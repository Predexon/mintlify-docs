...
<RequestExample>
```bash cURL
curl "https://api.predexon.com/v1/matching-markets/batch?polymarket_market_slugs=will-trump-win-2024&polymarket_market_slugs=will-fed-cut-rates-january&polymarket_market_slugs=will-btc-hit-100k"
```
...
response = requests.get(
    "https://api.predexon.com/v1/matching-markets/batch",
...
const response = await fetch(
  `https://api.predexon.com/v1/matching-markets/batch?${params}`
);
