---
title: "Wallet P&L"
api: "GET /v1/polymarket/wallet/pnl/{wallet_address}"
...
<RequestExample>
```bash cURL
curl "https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/wallet/pnl/0x1234...?granularity=day"
```
...
response = requests.get(
    f"https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/wallet/pnl/{wallet}",
    params={
        "granularity": "week",
...
const response = await fetch(
  `https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/wallet/pnl/${walletAddress}?granularity=month`
);
