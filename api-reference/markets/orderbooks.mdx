---
title: "Orderbooks"
api: "GET /v1/polymarket/orderbooks"
...
<Warning>
Orderbook data history starts from **October 14th, 2024**. Earlier data is not available.
</Warning>
...
<RequestExample>
```bash cURL
curl "https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/orderbooks?token_id=21742633...&start_time=1704067200000&end_time=1704153600000&limit=50"
```
...
response = requests.get(
    "https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/orderbooks",
    params={
        "token_id": token_id,
...
const response = await fetch(
  `https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/orderbooks?token_id=${tokenId}&start_time=1704067200000&end_time=1704153600000`
);
