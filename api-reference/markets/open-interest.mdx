...
api: "GET /v1/polymarket/markets/{condition_id}/open_interest"
...
<RequestExample>
```bash cURL
curl "https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/markets/0x1234.../open_interest?granularity=day"
```
...
response = requests.get(
    f"https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/markets/{condition_id}/open_interest",
    params={
        "granularity": "week",
...
const response = await fetch(
  `https://predexon-data-service-8970529761.us-central1.run.app/v1/polymarket/markets/${conditionId}/open_interest?granularity=week`
);
