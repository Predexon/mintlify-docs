---
title: "Predexon API"
description: "Unified prediction market data API for Polymarket, Kalshi, and Dflow"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Kalshi" icon="square-poll-vertical">
    Markets, trades, and orderbook data with cross-platform matching.
  </Card>
  <Card title="Dflow" icon="bolt">
    Wallet trades, positions, and PnL tracking on Solana.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    title="Join Discord"
    icon="discord"
    href="https://discord.com/invite/dxwzMcs8hX"
  >
